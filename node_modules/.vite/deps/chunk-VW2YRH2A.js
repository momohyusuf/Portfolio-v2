...
function getMonthLabels(weeks, monthNames = DEFAULT_MONTH_LABELS) {
  return weeks.reduce((labels, week, weekIndex) => {
    ...
    if (weekIndex === 0 || (prevLabel == null ? void 0 : prevLabel.label) !== month) {
      return [...labels, {
        weekIndex,
        label: month
      }];
...
var Tooltip = (0, import_react.lazy)(() => import("./Tooltip-B8gZJWmn-7XAUN42Z.js").then((module) => ({
  default: module.Tooltip
})));
var ActivityCalendar = (0, import_react.forwardRef)(({
  data: activities,
  blockMargin = 4,
  blockRadius = 2,
  blockSize = 12,
  ...
  function renderCalendar() {
    return weeks.map((week, weekIndex) => week.map((activity, dayIndex) => {
      ...
      const block = (0, import_jsx_runtime.jsx)("rect", {
        x: 0,
      ...
      return (0, import_jsx_runtime.jsx)(import_react.Fragment, {
        children: tooltips.activity ? (0, import_jsx_runtime.jsx)(import_react.Suspense, {
    ...
    })).map((week, x) => (0, import_jsx_runtime.jsx)("g", {
  ...
  function renderFooter() {
    ...
    return (0, import_jsx_runtime.jsxs)("footer", {
      ...
      children: [loading && (0, import_jsx_runtime.jsx)("div", {
        children: " "
      }), !loading && showTotalCount && (0, import_jsx_runtime.jsx)("div", {
      ...
      }), !loading && showColorLegend && (0, import_jsx_runtime.jsxs)("div", {
        className: getClassName("legend-colors"),
        style: styles.footer.legend,
        children: [labels.legend.less && (0, import_jsx_runtime.jsx)("span", {
          style: {
            marginRight: "0.4em"
          },
          children: labels.legend.less
        }), range(minLevel, maxLevel + 1).map((level) => {
          const colorLegend = (0, import_jsx_runtime.jsx)("svg", {
            width: blockSize,
            height: blockSize,
          ...
          return (0, import_jsx_runtime.jsx)(import_react.Fragment, {
            children: tooltips.colorLegend ? (0, import_jsx_runtime.jsx)(import_react.Suspense, {
        ...
        }), labels.legend.more && (0, import_jsx_runtime.jsx)("span", {
          style: {
            marginLeft: "0.4em"
          },
  ...
  return (0, import_jsx_runtime.jsxs)("article", {
    ref,
...
//# sourceMappingURL=chunk-VW2YRH2A.js.map
